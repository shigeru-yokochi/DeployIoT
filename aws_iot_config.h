...
// Get from console
// =================================================
#define AWS_IOT_MQTT_HOST              "a27q7eo8615pn1.iot.ap-northeast-1.amazonaws.com" ///< Customer specific MQTT HOST. The same will be used for Thing Shadow
#define AWS_IOT_MQTT_PORT              443 ///< default port for MQTT/S
#define AWS_IOT_MQTT_CLIENT_ID         "raspberrypi-zero-205" ///< MQTT client ID should be unique for every device
#define AWS_IOT_MY_THING_NAME 	       "raspberrypi-zero-205" ///< Thing Name of the Shadow this device is associated with
